...
public class Js_Cat_ItandSoftwareServiceDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_js__cat__itand_software_service_details);
