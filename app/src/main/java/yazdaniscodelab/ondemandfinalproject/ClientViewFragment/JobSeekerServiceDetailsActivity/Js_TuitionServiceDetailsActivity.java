package yazdaniscodelab.ondemandfinalproject.ClientViewFragment.JobSeekerServiceDetailsActivity;
...
public class Js_TuitionServiceDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_js__tuition_service_details);
