...
public class HomeServiceFragment extends Fragment {
    ...
    private DatabaseReference mPublicHomeService;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPublicHomeService= FirebaseDatabase.getInstance().getReference().child("Home_public");
        ...
        btn_postjob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String id=mHomeServiewDb.push().getKey();
                ...
                mHomeServiewDb.child(id).setValue(postJob);
                mPublicHomeService.child(id).setValue(postJob);
