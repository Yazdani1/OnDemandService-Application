 ...
 */
public class ItandSoftwareJobServiceCreateFragment extends Fragment {
    ...
    private DatabaseReference ItAndSoftwareCreateService;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myview=inflater.inflate(R.layout.fragment_itand_software_job_service_create, container, false);
        ...
        ItAndSoftwareCreateService= FirebaseDatabase.getInstance().getReference().child("ITandSoftwareCreate").child(uid);
        ...
        btnPostService.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String id=ItAndSoftwareCreateService.push().getKey();
                String mDate= DateFormat.getDateInstance().format(new Date());

                Services services=new Services(title,budget,skills,phone,description,mDate,id);

                ItAndSoftwareCreateService.child(id).setValue(services);
                PublicItAndSoftwareCreateService.child(id).setValue(services);
