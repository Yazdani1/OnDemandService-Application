...
import yazdaniscodelab.ondemandfinalproject.Model.ProfileData;
...
public class CreateProfielActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateProfileDatabase= FirebaseDatabase.getInstance().getReference().child("UserProfile").child(uId);
    ...
    private void createProfileFunc(){
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String id=mCreateProfileDatabase.push().getKey();

                String mDate= DateFormat.getDateTimeInstance().format(new Date());


                ProfileData profileData=new ProfileData(mName,mPhone,mDistrict,mAddress,id,mDate);
                mCreateProfileDatabase.setValue(profileData);
